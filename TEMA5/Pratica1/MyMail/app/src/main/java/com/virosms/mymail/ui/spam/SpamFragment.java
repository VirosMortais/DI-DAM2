package com.virosms.mymail.ui.spam;
...
import com.virosms.mymail.databinding.FragmentSpamBinding;
...
public class SpamFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        SpamViewModel spamViewModel = new ViewModelProvider(this).get(SpamViewModel.class);
